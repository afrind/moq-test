...
Upon receiving a valid SUBSCRIBE or FETCH for a moq-test track, the publisher MUST publish objects according to the parameters of the namespace.

Upon receiving a SUBSCRIBE_ANNOUNCES with a tracknamespace, the publisher MUST use PUBLISH to send objects according to the parameters of the namespace. If the publisher recieves a PUBLISH_ERROR, it will stop sending objects immediately.
